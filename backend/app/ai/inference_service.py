...
class InferenceService:
    ...
    def __init__(self):
        ...
        logger.info(f"InferenceService initialized with ModelService. GPU availability: {self.model.gpu_available}")
    ...
    def run_full_pipeline(self, image_features: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Inference pipeline completed in {processing_time_ms} ms. Model version: v1.0.0. GPU: {self.model.gpu_available}")
